...
;	assignBit
	setb	_EA
;	life.c:219: for (i0 = 0; !i0; ) {		
	mov	r0,#_i0
	mov	@r0,#0x00
00220$:
;	life.c:220: printstr("\033[2J\033[mLIFE INIT\r\n");
	mov	r5,#___str_4
	mov	r6,#(___str_4 >> 8)
	mov	r7,#0x80
;	life.c:52: return;
...
00435$:
	...
	ljmp	00133$
00436$:
;	life.c:224: else if (c == (int)'L') break;
	cjne	r6,#0x4c,00108$
	cjne	r7,#0x00,00108$
;	life.c:227: reload:
00110$:
...
;	life.c:234: c = toupper(getchar());
	...
	inc	r0
	mov	@r0,ar7
;	life.c:235: if (i0 || (c == (int)'T')) goto terminate;
	mov	r0,#_i0
	mov	a,@r0
	jz	00462$
	ljmp	00133$
00462$:
	...
	ljmp	00133$
00463$:
;	life.c:236: else if (c == (int)'L') goto reload;
	cjne	r6,#0x4c,00464$
	cjne	r7,#0x00,00464$
	ljmp	00110$
00464$:
;	life.c:237: else if (c == (int)'S') break;
	cjne	r6,#0x53,00121$
	cjne	r7,#0x00,00121$
...
;	life.c:189: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	...
	add	a,r3
	mov	r3,a
;	life.c:191: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	mov	a,#0x41
	...
	add	a,r3
	mov	r3,a
;	life.c:193: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x0d
	mov	r0,a
	mov	a,_bp
...
;	life.c:194: y1 = 1; x1 = 1;
	...
	inc	r0
	mov	@r0,#0x00
;	life.c:195: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x0d
	mov	r0,a
	mov	a,r6
	...
	mov	r0,#_n
	mov	@r0,ar7
;	life.c:197: nu[A2D(W, y, x)] = (n == 3) || ((n == 2) && u[A2D(W, y, x)]);
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,#_nu
...
00229$:
	...
	mov	dph,r6
	movx	@dptr,a
;	life.c:198: cycle2 |= pu[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	r0,#_y
	mov	ar6,@r0
	inc	r0
	mov	a,@r0
	...
	orl	a,@r0
	mov	@r0,a
;	life.c:199: fixed |= u[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,r6
	add	a,#_u
	mov	dpl,a
	mov	a,r7
...
00478$:
	...
	rlc	a
	mov	@r0,a
;	life.c:206: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:207: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
...
;	life.c:246: printstr("DONE ");
	...
	sjmp	00205$
00176$:
;	life.c:247: if (fixed) printstr("FIXED\r\n");
	mov	r0,#_fixed
	mov	a,@r0
	jz	00124$
	mov	r5,#___str_7
...
;	life.c:247: if (fixed) printstr("FIXED\r\n");
	...
	sjmp	00208$
00124$:
;	life.c:248: else printstr("CYCLE2\r\n");
	mov	r5,#___str_8
	mov	r6,#(___str_8 >> 8)
	mov	r7,#0x80
;	life.c:52: return;
...
;	life.c:219: for (i0 = 0; !i0; ) {		
	...
	ljmp	00220$
00491$:
;	life.c:260: terminate:
00133$:
;	life.c:261: EA = 0;
;	assignBit
	clr	_EA
;	life.c:262: printstr("TERM\r\n");
	mov	r5,#___str_10
	mov	r6,#(___str_10 >> 8)
	mov	r7,#0x80
;	life.c:52: return;
