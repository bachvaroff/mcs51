...
;	life.c:25: __idata static const char digits[16] = {
	...
	mov	@r0,#0x46
;	life.c:162: __idata static const char busy[4] = { '\\', '|', '/', '-' };
	mov	r0,#_busy
	mov	@r0,#0x5c
	mov	r0,#(_busy + 0x0001)
	mov	@r0,#0x7c
...
;	life.c:132: c = toupper(getchar());
	...
	inc	r0
	mov	@r0,ar7
;	life.c:133: if (c == (int)'0') {
	cjne	r6,#0x30,00149$
	cjne	r7,#0x00,00149$
;	life.c:134: u[A2D(W, y, x)] = 0;
	mov	r0,#_y
	mov	ar4,@r0
	inc	r0
	mov	a,@r0
...
;	life.c:136: break;
	sjmp	00154$
00149$:
;	life.c:137: } else if (c == (int)'1') {
	cjne	r6,#0x31,00147$
	cjne	r7,#0x00,00147$
;	life.c:138: u[A2D(W, y, x)] = 1;
	mov	r0,#_y
	mov	ar4,@r0
	inc	r0
	mov	a,@r0
...
;	life.c:140: break;
	sjmp	00154$
00147$:
;	life.c:141: } else if (c == (int)'S') goto br_inner;
	cjne	r6,#0x53,00447$
	cjne	r7,#0x00,00447$
	sjmp	00193$
00447$:
;	life.c:142: else if (c == (int)'#') goto out;
	cjne	r6,#0x23,00448$
	cjne	r7,#0x00,00448$
	sjmp	00164$
00448$:
...
;	life.c:153: c = getchar();
	...
	inc	r0
	mov	@r0,ar7
;	life.c:154: if (c == (int)'#') break;
	cjne	r6,#0x23,00160$
	cjne	r7,#0x00,00160$
00163$:
;	life.c:156: print16x(j);
	mov	r0,#_j
	mov	ar6,@r0
	inc	r0
	mov	ar7,@r0
...
;	life.c:169: for (y = 0; y < H; y++) {
	...
	mov	@r0,a
00202$:
;	life.c:170: putchar(busy[bstep]); putchar('\r');
	mov	r0,#_bstep
	mov	a,@r0
	add	a,#_busy
	mov	r1,a
