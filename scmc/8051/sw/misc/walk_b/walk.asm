...
;------------------------------------------------------------
;	walk.c:132: static volatile __xdata int *R = (__xdata int *)0xfffe;
...
;------------------------------------------------------------
;	walk.c:84: static int update(struct node *t, struct node *cur, char j) {
;	-----------------------------------------
;	 function update
;	-----------------------------------------
_update:
...
;	walk.c:88: if (t->r < 0) t->r += ROWS;
	...
	sjmp	00105$
00104$:
;	walk.c:89: else if (t->r >= ROWS) t->r -= ROWS;
	clr	c
	mov	a,r5
	subb	a,#0x30
	mov	a,r4
...
;	walk.c:90: if (t->c < 0) t->c += COLS;
	...
	sjmp	00110$
00109$:
;	walk.c:91: else if (t->c >= COLS) t->c -= COLS;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	dpl,@r0
	...
	lcall	__gptrput
00110$:
;	walk.c:93: if (g[t->r][t->c] == 0xaa) return 0;
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
	...
	sjmp	00116$
00114$:
;	walk.c:94: else if (g[t->r][t->c] != 0x55) bang();
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
...
;------------------------------------------------------------
;	walk.c:99: static void walk(struct node *nstart) {
;	-----------------------------------------
;	 function walk
;	-----------------------------------------
_walk:
	...
	add	a,#0x0d
	mov	sp,a
;	walk.c:104: if (!qadd(nstart)) bang();
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	push	ar7
	...
	pop	ar7
00102$:
;	walk.c:105: g[nstart->r][nstart->c] = 0xaa;
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
...
;	walk.c:107: process:
	...
	mov	r4,a
00103$:
;	walk.c:108: if (!qget(&cur)) goto term;
	push	ar5
	mov	ar2,r1
	mov	r3,#0x00
	mov	r5,#0x40
...
00160$:
	...
	pop	ar5
	pop	ar6
;	walk.c:112: goto process;
	ljmp	00103$
00109$:
;	walk.c:115: printf("\033[%d;%dH.", cur.r + 4, cur.c + 1);
	push	ar5
	mov	ar2,@r0
	inc	r0
	mov	ar3,@r0
	...
	pop	ar4
	pop	ar5
;	walk.c:116: printf("\033[2;1H% 8d% 8d% 8d% 8d", hp, tp, cur.r, cur.c);
	mov	ar7,@r0
	inc	r0
	mov	ar3,@r0
	dec	r0
...
;	walk.c:121: g[t.r][t.c] = 0xaa;
	...
	mov	a,#0xaa
	movx	@dptr,a
;	walk.c:122: printf("\033[%d;%dHo", t.r + 4, t.c + 1);
	mov	r0,ar4
	mov	ar5,@r0
	inc	r0
	mov	ar7,@r0
...
;	walk.c:144: qinit();
	lcall	_qinit
;	walk.c:146: puts("\033[2J\033[?25l");
	mov	dptr,#___str_4
	mov	b,#0x80
	lcall	_puts
;	walk.c:148: while (i0) {
...
00172$:
	...
	subb	a,#0x80
	jc	00121$
;	walk.c:153: initial.r = rand() % ROWS;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	push	ar7
	...
	mov	@r0,ar6
	dec	r0
;	walk.c:154: initial.c = rand() % COLS;
	mov	a,#0x02
	add	a,r1
	mov	r0,a
	push	ar1
...
;	walk.c:156: puts("\033[2J\033[?25l");
	...
	pop	ar0
	pop	ar1
;	walk.c:157: printf("\033[1;1H% 8u% 8d% 8d", N, initial.r, initial.c);
	mov	ar5,@r0
	inc	r0
	mov	ar6,@r0
	dec	r0
...
;	assignBit
	clr	_EA
;	walk.c:170: puts("\033[2J\033[?25h");
	mov	dptr,#___str_6
	mov	b,#0x80
	lcall	_puts
;	walk.c:174: __endasm;
...
;------------------------------------------------------------
;	walk.c:179: static void qinit(void) {
;	-----------------------------------------
;	 function qinit
;	-----------------------------------------
_qinit:
...
;------------------------------------------------------------
;	walk.c:184: static int qadd(struct node *t) {
;	-----------------------------------------
;	 function qadd
;	-----------------------------------------
_qadd:
	...
	mov	r5,dph
	mov	r6,b
;	walk.c:185: if (((hp + 1) % QMAX) == tp) return 0;
	mov	dptr,#_hp
	movx	a,@dptr
	mov	r3,a
	inc	dptr
...
;------------------------------------------------------------
;	walk.c:191: static int qget(struct node *t) {
;	-----------------------------------------
;	 function qget
;	-----------------------------------------
_qget:
