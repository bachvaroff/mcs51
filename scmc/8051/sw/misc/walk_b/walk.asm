...
_walk:
	...
	add	a,#0x20
	mov	sp,a
;	walk.c:115: if (!qadd(nstart)) bang();
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	push	ar7
	...
	pop	ar7
00102$:
;	walk.c:116: g[nstart->r][nstart->c] = 0xaau;
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
...
;	walk.c:118: process:
	...
	mov	r5,a
00103$:
;	walk.c:119: if (!qget(&cur)) goto term;
	mov	ar2,r5
	mov	r3,#0x00
	mov	r4,#0x40
	mov	dpl,r2
	...
	ljmp	00119$
00184$:
;	walk.c:121: printf("\033[2;1H% 8d% 8d% 8d% 8d", hp, tp, cur.r, cur.c);
	mov	a,#0x02
	add	a,r5
	mov	r4,a
	push	ar0
	...
	pop	ar5
	pop	ar7
;	walk.c:123: printf("\033[%d;%dH.", cur.r + 4, cur.c + 1);
	push	ar0
	mov	r0,ar4
	mov	ar4,@r0
	inc	r0
...
;	walk.c:124: flashOE(OE76_MASK6);
	...
	pop	ar5
	pop	ar7
;	walk.c:126: for (j = 0u; j < NMAX; j++)
	mov	r6,#0x00
;	walk.c:150: return;
;	walk.c:126: for (j = 0u; j < NMAX; j++)
00120$:
;	walk.c:127: scramble[j] = j;
	mov	a,r6
	add	a,r7
	push	ar0
	mov	r0,a
...
00186$:
	jc	00120$
;	walk.c:129: do ti = (uint8_t)(rand() % NMAX);
	mov	r4,#0x00
00107$:
	push	ar7
	push	ar5
	...
	anl	ar2,#0x0f
	mov	r3,#0x00
;	walk.c:130: while (ti == j);
	mov	a,r2
	cjne	a,ar4,00188$
	sjmp	00107$
00188$:
;	walk.c:131: do tj = (uint8_t)(rand() % NMAX);
00110$:
	push	ar5
	push	ar7
	push	ar4
	...
	anl	ar3,#0x0f
	mov	ar6,r3
;	walk.c:132: while (ti == tj);
	mov	a,r2
	cjne	a,ar6,00189$
	pop	ar5
	sjmp	00110$
00189$:
;	walk.c:133: tx = scramble[ti];
	mov	a,r2
	add	a,r7
	mov	r3,a
	push	ar0
	...
	mov	a,@r1
	mov	@r0,a
;	walk.c:134: scramble[ti] = scramble[tj];
	mov	a,r6
	add	a,r7
	mov	r5,a
	mov	r0,ar5
...
;	walk.c:135: scramble[tj] = tx;
	...
	pop	ar0
	pop	ar1
;	walk.c:128: for (j = 0u; j < NMAX; j++) {
	inc	r4
	cjne	r4,#0x10,00190$
00190$:
	pop	ar5
	jc	00107$
;	walk.c:138: for (j = 0u; j < NMAX; j++)
	push	ar0
	mov	r0,_bp
	inc	r0
	mov	@r0,ar5
	...
	pop	ar0
00124$:
;	walk.c:139: if (update(&t, &cur, scramble[j])) {
	push	ar5
	push	ar0
	mov	a,_bp
	add	a,#0x20
...
;	walk.c:141: g[t.r][t.c] = 0xaau;
	...
	mov	a,#0xaa
	movx	@dptr,a
;	walk.c:143: printf("\033[%d;%dHo", t.r + 4, t.c + 1);
	mov	ar4,@r0
	inc	r0
	mov	ar6,@r0
	dec	r0
