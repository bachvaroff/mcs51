...
;------------------------------------------------------------
;	walk.c:195: static void stinit(void) {
;	-----------------------------------------
;	 function stinit
;	-----------------------------------------
_stinit:
...
;------------------------------------------------------------
;	walk.c:200: static int stpush(struct node *t) {
;	-----------------------------------------
;	 function stpush
;	-----------------------------------------
_stpush:
	...
	mov	r6,dph
	mov	r7,b
;	walk.c:201: if (sp == (SMAX - 1)) return 0;
	mov	dptr,#_sp
	movx	a,@dptr
	mov	r3,a
	inc	dptr
...
;t                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	walk.c:207: static int stpop(struct node *t) {
;	-----------------------------------------
;	 function stpop
;	-----------------------------------------
_stpop:
