...
;	walk.c:115: process:
	...
	mov	r0,a
00101$:
;	walk.c:116: g[cur.r][cur.c] = 0xaau;
	push	ar2
	mov	ar2,@r1
	inc	r1
	mov	ar5,@r1
	...
	mov	a,#0xaa
	movx	@dptr,a
;	walk.c:118: printf("\033[%d;%dHo", cur.r + 4, cur.c + 1);
	mov	ar2,@r0
	inc	r0
	mov	ar5,@r0
	dec	r0
...
;	walk.c:121: next:
00102$:
;	walk.c:122: printf("\033[2;1H% 8d% 8d% 8d", sp, cur.r, cur.c);
	push	ar2
	mov	ar7,@r0
	inc	r0
	mov	ar4,@r0
	...
	pop	ar2
	pop	ar6
;	walk.c:124: for (j = 0u, f = 0u; j < NMAX; j++) {
	mov	r3,#0x00
	push	ar0
	mov	a,_bp
	add	a,#0x12
...
00159$:
	pop	ar0
	jnc	00106$
;	walk.c:125: if (!update(&t, &cur, j)) continue;
	push	ar2
	push	ar0
	mov	a,_bp
	add	a,#0x06
...
;	walk.c:130: while (1) {
00112$:
;	walk.c:131: j = (uint8_t)(rand() % NMAX);
	push	ar2
	push	ar6
	push	ar2
	push	ar1
	...
	anl	ar5,#0x0f
	mov	ar4,r5
;	walk.c:132: if (!update(&t, &cur, j)) continue;
	push	ar0
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
...
;	walk.c:134: cur = t;
	...
	pop	ar2
	pop	ar6
;	walk.c:135: goto process;
	pop	ar2
	ljmp	00101$
00115$:
;	walk.c:139: printf("\033[%d;%dH.", cur.r + 4, cur.c + 1);
	mov	ar5,@r0
	inc	r0
	mov	ar7,@r0
	dec	r0
...
;	walk.c:140: flashOE(OE76_MASK6);
	...
	pop	ar2
	pop	ar6
;	walk.c:142: if (stpop(&cur)) goto next;
	push	ar0
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
...
;	walk.c:160: stinit();
	lcall	_stinit
;	walk.c:162: puts("\033[2J\033[?25l");
	mov	dptr,#___str_4
	mov	b,#0x80
	lcall	_puts
;	walk.c:164: while (i0) {
...
00185$:
	...
	subb	a,#0x80
	jc	00125$
;	walk.c:169: initial.r = rand() % ROWS;
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	push	ar7
	...
	mov	@r0,ar6
	dec	r0
;	walk.c:170: initial.c = rand() % COLS;
	mov	a,#0x02
	add	a,r1
	mov	r0,a
	push	ar1
	...
	mov	@r0,ar6
	dec	r0
;	walk.c:172: puts("\033[2J\033[?25l");
	mov	dptr,#___str_4
	mov	b,#0x80
	push	ar0
	lcall	_puts
	pop	ar0
	pop	ar1
;	walk.c:173: printf("\033[1;1H% 8u% 8d% 8d", N, initial.r, initial.c);
	mov	ar5,@r0
	inc	r0
	mov	ar6,@r0
	dec	r0
...
;	walk.c:175: for (i = 0; i < REG; i++) {
	...
	mov	@r0,a
00116$:
;	walk.c:176: neigh[i].r = neigh[REG + i].r * (1 + rand() % 8);
	push	ar7
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
...
00189$:
	...
	inc	dptr
	movx	@dptr,a
;	walk.c:177: neigh[i].c = neigh[REG + i].c * (1 + rand() % 8);
	mov	a,r3
	add	a,#_neigh
	mov	r3,a
	mov	a,r4
...
00191$:
	...
	ljmp	00116$
00192$:
;	walk.c:181: OE76 = OE76_0;
	mov	r0,#_OE76
	mov	@r0,#0x3f
;	walk.c:182: flashOE(OE76_NC);
	mov	dpl,#0x00
	push	ar7
	push	ar1
	lcall	_flashOE
...
00132$:
	...
	mov	r6,#0x00
00118$:
;	walk.c:188: if (g[i][j] != 0xaau) bang();
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,r2
...
;	assignBit
	clr	_EA
;	walk.c:195: puts("\033[2J\033[?25h");
	mov	dptr,#___str_7
	mov	b,#0x80
	lcall	_puts
;	walk.c:35: PCON |= 2;
