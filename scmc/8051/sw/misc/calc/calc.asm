...
;	calc.c:399: printf("\r\nbase = %d, ", ctx->base);
	...
	add	a,#0xfb
	mov	sp,a
;	calc.c:400: printf("acc = %ld / ", ctx->acc);
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	r1,_bp
	...
	add	a,#0xf9
	mov	sp,a
;	calc.c:401: printf("%08lx / ", ctx->acc);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
...
;	calc.c:403: printf(", acc_valid = %d\r\n", (int)ctx->acc_valid);
	...
	add	a,#0xfb
	mov	sp,a
;	calc.c:404: printf("primary = %p, secondary = %p\r\n", ctx->ps, ctx->ss);
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,#0x14
...
;s                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	calc.c:409: static int help(void *_ctx, delta_t *delta) __reentrant {
;	-----------------------------------------
;	 function help
;	-----------------------------------------
_help:
...
;	calc.c:413: printstr("\r\nHhOo\tbase 16 10 8 2\r\n");
	...
	sjmp	00164$
00102$:
;	calc.c:414: printstr("p\tpeek top\r\n");
	mov	r5,#___str_20
	mov	r6,#(___str_20 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:414: printstr("p\tpeek top\r\n");
	...
	sjmp	00167$
00104$:
;	calc.c:415: printstr("P\tprint stack\r\n");
	mov	r5,#___str_21
	mov	r6,#(___str_21 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:417: printstr("V\tpop all\r\n");
	...
	sjmp	00176$
00110$:
;	calc.c:418: printstr("i\treset acc\r\n");
	mov	r5,#___str_24
	mov	r6,#(___str_24 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:418: printstr("i\treset acc\r\n");
	...
	sjmp	00179$
00112$:
;	calc.c:419: printstr("I\treset and discard acc\r\n");
	mov	r5,#___str_25
	mov	r6,#(___str_25 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:419: printstr("I\treset and discard acc\r\n");
	...
	sjmp	00182$
00114$:
;	calc.c:420: printstr("x\texchange top 2\r\n");
	mov	r5,#___str_26
	mov	r6,#(___str_26 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:420: printstr("x\texchange top 2\r\n");
	...
	sjmp	00185$
00116$:
;	calc.c:421: printstr("X\texchange stacks primary <-> secondary\r\n");
	mov	r5,#___str_27
	mov	r6,#(___str_27 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:421: printstr("X\texchange stacks primary <-> secondary\r\n");
	...
	sjmp	00188$
00118$:
;	calc.c:422: printstr("T\texchange tops primary <-> secondary\r\n");
	mov	r5,#___str_28
	mov	r6,#(___str_28 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:422: printstr("T\texchange tops primary <-> secondary\r\n");
	...
	sjmp	00191$
00120$:
;	calc.c:423: printstr("U\tcopy top secondary -> primary\r\n");
	mov	r5,#___str_29
	mov	r6,#(___str_29 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:423: printstr("U\tcopy top secondary -> primary\r\n");
	...
	sjmp	00194$
00122$:
;	calc.c:424: printstr("u\tcopy top primary -> secondary\r\n");
	mov	r5,#___str_30
	mov	r6,#(___str_30 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:424: printstr("u\tcopy top primary -> secondary\r\n");
	...
	sjmp	00197$
00124$:
;	calc.c:425: printstr("M\tmove top secondary -> primary\r\n");
	mov	r5,#___str_31
	mov	r6,#(___str_31 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:425: printstr("M\tmove top secondary -> primary\r\n");
	...
	sjmp	00200$
00126$:
;	calc.c:426: printstr("m\tmove top primary -> secondary\r\n");
	mov	r5,#___str_32
	mov	r6,#(___str_32 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:427: printstr("+\tadd top 2\r\n");
	...
	sjmp	00206$
00130$:
;	calc.c:428: printstr("-\tsubtract top 2\r\n");
	mov	r5,#___str_34
	mov	r6,#(___str_34 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:428: printstr("-\tsubtract top 2\r\n");
	...
	sjmp	00209$
00132$:
;	calc.c:429: printstr("*\tmultiply top 2\r\n");
	mov	r5,#___str_35
	mov	r6,#(___str_35 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:429: printstr("*\tmultiply top 2\r\n");
	...
	sjmp	00212$
00134$:
;	calc.c:430: printstr("/\tdivide top 2\r\n");
	mov	r5,#___str_36
	mov	r6,#(___str_36 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:430: printstr("/\tdivide top 2\r\n");
	...
	sjmp	00215$
00136$:
;	calc.c:431: printstr("\\\tdivide top 2 unsigned\r\n");	
	mov	r5,#___str_37
	mov	r6,#(___str_37 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:431: printstr("\\\tdivide top 2 unsigned\r\n");	
	...
	sjmp	00218$
00138$:
;	calc.c:432: printstr("%\tmodulus top 2\r\n");
	mov	r5,#___str_38
	mov	r6,#(___str_38 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:432: printstr("%\tmodulus top 2\r\n");
	...
	sjmp	00221$
00140$:
;	calc.c:433: printstr("#\tmodulus top 2 unsigned\r\n");
	mov	r5,#___str_39
	mov	r6,#(___str_39 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:436: printstr("^\txor top 2\r\n");
	...
	sjmp	00233$
00148$:
;	calc.c:437: printstr(">\tshift right top 2\r\n");
	mov	r5,#___str_43
	mov	r6,#(___str_43 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:437: printstr(">\tshift right top 2\r\n");
	...
	sjmp	00236$
00150$:
;	calc.c:438: printstr("]\tarithmetic shift right top 2\r\n");
	mov	r5,#___str_44
	mov	r6,#(___str_44 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:438: printstr("]\tarithmetic shift right top 2\r\n");
	...
	sjmp	00239$
00152$:
;	calc.c:439: printstr("<\tshift left top 2\r\n");
	mov	r5,#___str_45
	mov	r6,#(___str_45 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;	calc.c:439: printstr("<\tshift left top 2\r\n");
	...
	sjmp	00242$
00154$:
;	calc.c:440: printstr("~\tbitwise not top\r\n");
	mov	r5,#___str_46
	mov	r6,#(___str_46 >> 8)
	mov	r7,#0x80
;	calc.c:51: return;
...
;__1966080191              Allocated to registers 
;s                         Allocated to registers r2 r3 r4 
;__1310720193              Allocated to registers 
;s                         Allocated to registers r5 r6 r7 
;sloc0                     Allocated to stack - _bp +1
;------------------------------------------------------------
;	calc.c:476: void main(void) {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
...
;	calc.c:480: c.acc = 0l;
	...
	inc	dptr
	movx	@dptr,a
;	calc.c:481: c.acc_valid = (char)0;
	mov	dptr,#(_c + 0x0006)
	movx	@dptr,a
;	calc.c:482: c.digit[0] = c.digit[1] = '\0';
	mov	dptr,#(_c + 0x0008)
	movx	@dptr,a
	mov	dptr,#(_c + 0x0007)
	movx	@dptr,a
;	calc.c:484: c.ps = &c.s0;
	mov	dptr,#(_c + 0x4011)
	mov	a,#(_c + 0x0009)
	movx	@dptr,a
	mov	a,#((_c + 0x0009) >> 8)
...
;	calc.c:485: c.ss = &c.s1;
	...
	inc	dptr
	movx	@dptr,a
;	calc.c:486: stack_init(c.ps);
	mov	dptr,#(_c + 0x0009)
	mov	b,#0x00
	lcall	_stack_init
;	calc.c:487: stack_init(c.ss);
	mov	dptr,#(_c + 0x4014)
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	b,r7
	lcall	_stack_init
;	calc.c:489: state_init(&s, STATE_START, STATE_FINAL, UNDEF, deltas, &c);
	mov	a,#_c
	push	acc
	mov	a,#(_c >> 8)
	push	acc
	...
	add	a,#0xf4
	mov	sp,a
;	calc.c:491: (void)status(&c, deltas);
	mov	a,#_deltas
	push	acc
	mov	a,#(_deltas >> 8)
	push	acc
...
;	calc.c:493: while (1) {
00192$:
;	calc.c:494: input = getchar();
	lcall	_getchar
	mov	r6,dpl
	mov	r7,dph
;	calc.c:495: if (((char)input == '\r') || ((char)input == '\n')) printstr("\r\n");
	mov	ar5,r6
	cjne	r5,#0x0d,00400$
	sjmp	00101$
00400$:
...
;	calc.c:495: if (((char)input == '\r') || ((char)input == '\n')) printstr("\r\n");
	sjmp	00199$
00102$:
;	calc.c:496: else (void)putchar(input);
	mov	dpl,r6
	mov	dph,r7
	lcall	_putchar
00103$:
;	calc.c:497: c.digit[0] = (char)input;
	mov	dptr,#(_c + 0x0007)
	mov	a,r5
	movx	@dptr,a
;	calc.c:499: if ((char)input == 'q') {
	cjne	r5,#0x71,00189$
;	calc.c:500: if (state_exec(&s, EVENT_TERM) <= 0) break;
	mov	a,#0x08
	push	acc
	clr	a
	push	acc
	...
	ljmp	00193$
00189$:
;	calc.c:501: } else if ((char)input == 's') {
	cjne	r5,#0x73,00186$
;	calc.c:502: if (state_exec(&s, EVENT_STATUS) <= 0) break;
	mov	a,#0x03
	push	acc
	clr	a
	push	acc
...
00410$:
	ljmp	00193$
00186$:
;	calc.c:503: } else if ((char)input == '?') {
	cjne	r5,#0x3f,00183$
;	calc.c:504: if (state_exec(&s, EVENT_HELP) <= 0) break;
	mov	a,#0x04
	push	acc
	clr	a
	push	acc
...
00413$:
	ljmp	00193$
00183$:
;	calc.c:505: } else if ((char)input == 'i') {
	cjne	r5,#0x69,00180$
;	calc.c:506: if (state_exec(&s, EVENT_RSTA_i) <= 0) break;
	mov	a,#0x06
	push	acc
	clr	a
	push	acc
...
00416$:
	ljmp	00193$
00180$:
;	calc.c:507: } else if ((char)input == 'I') {
	cjne	r5,#0x49,00177$
;	calc.c:508: if (state_exec(&s, EVENT_RSTA_I) <= 0) break;
	mov	a,#0x07
	push	acc
	clr	a
	push	acc
...
00419$:
	ljmp	00193$
00177$:
;	calc.c:510: ((char)input == 'h') || ((char)input == 'H') ||
	cjne	r5,#0x68,00420$
	sjmp	00170$
00420$:
	cjne	r5,#0x48,00421$
	sjmp	00170$
00421$:
;	calc.c:511: ((char)input == 'o') || ((char)input == 'O')
	cjne	r5,#0x6f,00422$
	sjmp	00170$
00422$:
	cjne	r5,#0x4f,00171$
00170$:
;	calc.c:513: if (state_exec(&s, EVENT_BASE) <= 0) break;
	mov	a,#0x05
	push	acc
	clr	a
	push	acc
...
00425$:
	ljmp	00193$
00171$:
;	calc.c:514: } else if (isxdigit(input)) {
	mov	dpl,r6
	mov	dph,r7
	push	ar5
	lcall	_isxdigit
	...
	orl	a,b
	jz	00168$
;	calc.c:515: if (state_exec(&s, EVENT_DIGIT) <= 0) break;
	mov	a,#0x01
	push	acc
	clr	a
	push	acc
...
00427$:
	ljmp	00193$
00168$:
;	calc.c:517: ((char)input == 'p') || ((char)input == 'P') ||
	cjne	r5,#0x70,00428$
	sjmp	00159$
00428$:
	cjne	r5,#0x50,00429$
	sjmp	00159$
00429$:
;	calc.c:518: ((char)input == 'v') || ((char)input == 'V') ||
	cjne	r5,#0x76,00430$
	sjmp	00159$
00430$:
	cjne	r5,#0x56,00431$
	sjmp	00159$
00431$:
;	calc.c:519: ((char)input == '.') ||
	cjne	r5,#0x2e,00432$
	sjmp	00159$
00432$:
;	calc.c:520: ((char)input == 'x')
	cjne	r5,#0x78,00160$
00159$:
...
00435$:
	ljmp	00193$
00160$:
;	calc.c:524: ((char)input == 'X') || ((char)input == 'T') ||
	cjne	r5,#0x58,00436$
	sjmp	00151$
00436$:
	cjne	r5,#0x54,00437$
	sjmp	00151$
00437$:
;	calc.c:525: ((char)input == 'm') || ((char)input == 'M') ||
	cjne	r5,#0x6d,00438$
	sjmp	00151$
00438$:
	cjne	r5,#0x4d,00439$
	sjmp	00151$
00439$:
;	calc.c:526: ((char)input == 'u') || ((char)input == 'U')
	cjne	r5,#0x75,00440$
	sjmp	00151$
00440$:
	cjne	r5,#0x55,00152$
...
00444$:
	cjne	r5,#0x2d,00148$
00147$:
;	calc.c:532: if (state_exec(&s, EVENT_OP) <= 0) break;
	mov	a,#0x02
	push	acc
	clr	a
	push	acc
...
;	calc.c:534: ((char)input == '*') ||
	...
	sjmp	00140$
00448$:
;	calc.c:535: ((char)input == '/') || ((char)input == '\\') ||
	cjne	r5,#0x2f,00449$
	sjmp	00140$
00449$:
	cjne	r5,#0x5c,00450$
	sjmp	00140$
00450$:
;	calc.c:536: ((char)input == '%') || ((char)input == '#')
	cjne	r5,#0x25,00451$
	sjmp	00140$
00451$:
	cjne	r5,#0x23,00141$
...
00456$:
	...
	sjmp	00131$
00457$:
;	calc.c:542: ((char)input == '~') ||
	cjne	r5,#0x7e,00458$
	sjmp	00131$
00458$:
;	calc.c:543: ((char)input == '>') || ((char)input == ']') ||
	cjne	r5,#0x3e,00459$
	sjmp	00131$
00459$:
	cjne	r5,#0x5d,00460$
...
;	calc.c:546: if (state_exec(&s, EVENT_OP) <= 0) break;
	...
	ljmp	00192$
00132$:
;	calc.c:548: if (state_exec(&s, EVENT_DELIM) <= 0) break;
	clr	a
	push	acc
	push	acc
	mov	dptr,#_s
