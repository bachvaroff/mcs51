...
;	life.c:232: for (i0 = 0; !i0; ) {	
	...
	mov	@r0,#0x00
00246$:
;	life.c:233: printstr("\033[2J\033[?25l\033[mLIFE INIT T L R P\r\n");
	mov	r5,#___str_5
	mov	r6,#(___str_5 >> 8)
	mov	r7,#0x80
;	life.c:50: return;
...
00516$:
	...
	ljmp	00142$
00517$:
;	life.c:237: else if ((c == (int)'L') || (c == (int)'R') || (c == (int)'P')) break;
	cjne	r6,#0x4c,00518$
	cjne	r7,#0x00,00518$
	sjmp	00291$
00518$:
...
;	life.c:242: if (c == (int)'L') loadiu();
	...
	sjmp	00211$
00116$:
;	life.c:243: else if (c == (int)'R') loadriu();
	mov	r0,#_c
	cjne	@r0,#0x52,00544$
	inc	r0
	cjne	@r0,#0x00,00544$
...
;	life.c:243: else if (c == (int)'R') loadriu();
	...
	sjmp	00221$
00117$:
;	life.c:244: memcpy(u, iu, sizeof (iu));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
...
;	life.c:245: show(0);
	mov	dpl,#0x00
	lcall	_show
;	life.c:247: printstr("READY T L R P S\r\n");
	mov	r5,#___str_6
	mov	r6,#(___str_6 >> 8)
	mov	r7,#0x80
;	life.c:50: return;
...
;	life.c:249: c = toupper(getchar());
	...
	inc	r0
	mov	@r0,ar7
;	life.c:250: if (i0 || (c == (int)'T')) goto terminate;
	mov	r0,#_i0
	mov	a,@r0
	jz	00555$
	ljmp	00142$
00555$:
	...
	ljmp	00142$
00556$:
;	life.c:251: else if ((c == (int)'L') || (c == (int)'R') || (c == (int)'P')) goto reload;
	cjne	r6,#0x4c,00557$
	cjne	r7,#0x00,00557$
	ljmp	00112$
00557$:
...
00558$:
	...
	ljmp	00112$
00559$:
;	life.c:252: else if (c == (int)'S') break;
	cjne	r6,#0x53,00130$
	cjne	r7,#0x00,00130$
...
;	life.c:261: printstr("DONE ");
	...
	sjmp	00231$
00192$:
;	life.c:262: if (fixed) printstr("FIXED\r\n");
	mov	r0,#_fixed
	mov	a,@r0
	jz	00133$
	mov	r5,#___str_8
...
;	life.c:262: if (fixed) printstr("FIXED\r\n");
	...
	sjmp	00234$
00133$:
;	life.c:263: else printstr("CYCLE2\r\n");
	mov	r5,#___str_9
	mov	r6,#(___str_9 >> 8)
	mov	r7,#0x80
;	life.c:50: return;
...
;	life.c:232: for (i0 = 0; !i0; ) {	
	...
	ljmp	00246$
00586$:
;	life.c:275: terminate:
00142$:
;	life.c:276: EA = 0;
;	assignBit
	clr	_EA
;	life.c:277: printstr("TERM\r\n");
	mov	r5,#___str_11
	mov	r6,#(___str_11 >> 8)
	mov	r7,#0x80
;	life.c:50: return;
