...
;	life.c:218: c = getchar();
	...
	inc	dptr
	movx	@dptr,a
;	life.c:219: if (c == (int)'L') goto reload;
	cjne	r6,#0x4c,00393$
	cjne	r7,#0x00,00393$
	ljmp	00106$
00393$:
;	life.c:220: if (c == (int)'S') break;
	cjne	r6,#0x53,00112$
	cjne	r7,#0x00,00112$
