...
;	life.c:117: if (hdr) {
	...
	ljmp	00102$
00190$:
;	life.c:118: printstr("\033[2J\033[mGEN ");
	mov	r5,#___str_0
	mov	r6,#(___str_0 >> 8)
	mov	r7,#0x80
;	life.c:53: return;
...
;	life.c:125: for (y = 0; y < H; y++)
	...
	mov	@r0,a
00126$:
;	life.c:126: if (u[A2D(W, y, x)]) putchar('1');
	mov	r0,#_y
	mov	a,@r0
	push	acc
	inc	r0
...
;	life.c:256: for (i0 = 0; !i0; ) {	
	...
	mov	@r0,#0x00
00246$:
;	life.c:257: printstr("\033[2J\033[?25l\033[mLIFE INIT T L R P\r\n");
	mov	r5,#___str_5
	mov	r6,#(___str_5 >> 8)
	mov	r7,#0x80
;	life.c:53: return;
...
00291$:
00112$:
;	life.c:135: memset(u, 0, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
	...
	dec	sp
	dec	sp
;	life.c:136: memset(pu, 0, sizeof (pu));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
...
;	life.c:157: break;
	sjmp	00163$
00156$:
;	life.c:158: } else if (c == (int)'~') goto br_inner;
	cjne	r6,#0x7e,00532$
	cjne	r7,#0x00,00532$
	sjmp	00209$
00532$:
;	life.c:159: else if (c == (int)'#') goto out;
;	life.c:163: break;
	cjne	r6,#0x23,00160$
	cjne	r7,#0x00,00160$
	sjmp	00173$
...
;	life.c:170: c = getchar();
	...
	inc	r0
	mov	@r0,ar7
;	life.c:171: if (c == (int)'#') break;
	cjne	r6,#0x23,00169$
	cjne	r7,#0x00,00169$
00172$:
;	life.c:173: print16x(j);
	mov	r0,#_j
	mov	ar6,@r0
	inc	r0
	mov	ar7,@r0
...
;	life.c:204: n = -u[A2D(W, y, x)];
	...
	subb	a,r3
	mov	@r0,a
;	life.c:207: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	r0,#_y
	mov	a,#0xff
	add	a,@r0
	mov	r2,a
	...
	add	a,@r0
	mov	@r0,a
;	life.c:209: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	r0,#_x
	mov	a,_bp
	add	a,#0x06
	mov	r1,a
	...
	add	a,@r0
	mov	@r0,a
;	life.c:211: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	a,#0x31
	...
	add	a,@r0
	mov	@r0,a
;	life.c:213: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	r0,#_y
	mov	a,_bp
	add	a,#0x0a
	mov	r1,a
	...
	add	a,@r0
	mov	@r0,a
;	life.c:215: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x0c
	mov	r0,a
	mov	a,_bp
	...
	add	a,@r0
	mov	@r0,a
;	life.c:217: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x0c
	mov	r0,a
	mov	a,r6
	...
	add	a,@r0
	mov	@r1,a
;	life.c:219: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x0a
	mov	r0,a
	mov	a,#0xc1
	...
	add	a,@r0
	mov	@r1,a
;	life.c:221: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x08
	mov	r0,a
	mov	a,@r0
...
;	life.c:222: y1 = 1; x1 = 1;
	...
	inc	r0
	mov	@r0,#0x00
;	life.c:223: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,r6
	add	a,r2
	mov	r6,a
	mov	a,r7
	...
	mov	r0,#_n
	mov	@r0,ar7
;	life.c:225: nu[A2D(W, y, x)] = (n == 3) || ((n == 2) && u[A2D(W, y, x)]);
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
...
00255$:
	...
	mov	dph,r6
	movx	@dptr,a
;	life.c:226: cycle2 |= pu[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	r0,#_y
	mov	a,@r0
	push	acc
	inc	r0
	...
	orl	a,@r0
	mov	@r0,a
;	life.c:227: fixed |= u[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,r6
	add	a,#_u
	mov	dpl,a
	mov	a,r7
...
00573$:
	...
	rlc	a
	mov	@r0,a
;	life.c:237: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:238: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
...
;	life.c:285: printstr("DONE ");
	...
	sjmp	00231$
00192$:
;	life.c:286: if (fixed) printstr("FIXED\r\n");
	mov	r0,#_fixed
	mov	a,@r0
	jz	00133$
	mov	r5,#___str_8
...
;	life.c:286: if (fixed) printstr("FIXED\r\n");
	...
	sjmp	00234$
00133$:
;	life.c:287: else printstr("CYCLE2\r\n");
	mov	r5,#___str_9
	mov	r6,#(___str_9 >> 8)
	mov	r7,#0x80
;	life.c:53: return;
