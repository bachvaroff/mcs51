...
;	life.c:24: __idata static const char digits[16] = {
	mov	r0,#_digits
	mov	@r0,#0x30
	...
	mov	@r0,#0x46
;	life.c:152: __idata static const char busy[4] = { '\\', '|', '/', '-' };
	mov	r0,#_busy
	mov	@r0,#0x5c
	mov	r0,#(_busy + 0x0001)
	mov	@r0,#0x7c
...
;------------------------------------------------------------
;	life.c:53: void int0(void) __interrupt IE0_VECTOR __using 1 {
;	-----------------------------------------
;	 function int0
;	-----------------------------------------
_int0:
...
;------------------------------------------------------------
;	life.c:57: void int1(void) __interrupt IE1_VECTOR __using 1 {
;	-----------------------------------------
;	 function int1
;	-----------------------------------------
_int1:
...
;	life.c:96: if (hdr) {
	...
	ljmp	00102$
00190$:
;	life.c:97: printstr("\033[2J\033[m");
	mov	r5,#___str_0
	mov	r6,#(___str_0 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
...
;	life.c:97: printstr("\033[2J\033[m");
	...
	sjmp	00121$
00109$:
;	life.c:89: print16x(generation[1]);
...
;	life.c:40: putchar(digits[a & 0xf]);
	...
	mov	dph,r6
	lcall	_putchar
;	life.c:90: print16x(generation[0]);
	mov	r0,#_generation
	mov	ar6,@r0
	inc	r0
;	life.c:37: putchar(digits[(a >> 12) & 0xf]);
...
00199$:
	...
	inc	r0
	mov	@r0,ar7
;	life.c:83: if (!generation[0]) generation[1]++;
	mov	a,r6
	orl	a,r7
	jnz	00102$
	mov	r0,#(_generation + 0x0002)
...
;	assignBit
	setb	_EA
;	life.c:206: for (i0 = 0; !i0; ) {		
	mov	r0,#_i0
	mov	@r0,#0x00
00210$:
;	life.c:207: printstr("\033[2J\033[mINIT\r\n");
	mov	r5,#___str_4
	mov	r6,#(___str_4 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
...
;	life.c:209: c = getchar();
	...
	inc	r0
	mov	@r0,ar7
;	life.c:210: if (i0 || (c == (int)'T')) goto terminate;
	mov	r0,#_i0
	mov	a,@r0
	jz	00421$
	ljmp	00130$
00421$:
	...
	ljmp	00130$
00422$:
;	life.c:211: if (c == (int)'L') break;
	cjne	r6,#0x4c,00107$
	cjne	r7,#0x00,00107$
;	life.c:214: reload:
00109$:
;	life.c:117: memset(u, 0, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
	...
	dec	sp
	dec	sp
;	life.c:118: memset(pu, 0, sizeof (pu));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
...
00447$:
	...
	ljmp	00130$
00448$:
;	life.c:223: if (c == (int)'L') goto reload;
	cjne	r6,#0x4c,00449$
	cjne	r7,#0x00,00449$
	ljmp	00109$
00449$:
;	life.c:224: if (c == (int)'S') break;
	cjne	r6,#0x53,00118$
	cjne	r7,#0x00,00118$
;	life.c:75: generation[0] = 0;
	mov	r0,#_generation
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	life.c:76: generation[1] = 0;
	mov	r0,#(_generation + 0x0002)
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	life.c:229: for (i1 = 0; !i0 && !i1; ) {
	mov	r0,#_i1
	mov	@r0,#0x00
00205$:
	mov	r0,#_i0
...
;	life.c:159: for (y = 0; y < H; y++) {
	...
	mov	@r0,a
00192$:
;	life.c:160: putchar(busy[bstep]); putchar('\r');
	mov	r0,#_bstep
	mov	a,@r0
	add	a,#_busy
	mov	r1,a
...
;	life.c:163: n = -u[A2D(W, y, x)];
	...
	subb	a,r3
	mov	r3,a
;	life.c:166: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	r0,#_y
	mov	a,#0xff
	add	a,@r0
	mov	r2,a
	...
	add	a,r3
	mov	r3,a
;	life.c:168: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	r0,#_x
	mov	a,_bp
	add	a,#0x07
	mov	r1,a
	...
	add	a,r3
	mov	r3,a
;	life.c:170: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	a,#0x21
	...
	add	a,r3
	mov	r3,a
;	life.c:172: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	mov	r0,#_y
	mov	a,_bp
	add	a,#0x0b
	mov	r1,a
...
;	life.c:182: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	...
	mov	r0,#_n
	mov	@r0,ar7
;	life.c:184: nu[A2D(W, y, x)] = (n == 3) || ((n == 2) && u[A2D(W, y, x)]);
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,#_nu
...
00219$:
	...
	mov	dph,r6
	movx	@dptr,a
;	life.c:185: cycle2 |= pu[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	r0,#_y
	mov	ar6,@r0
	inc	r0
	mov	a,@r0
	...
	orl	a,@r0
	mov	@r0,a
;	life.c:186: fixed |= u[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,r6
	add	a,#_u
	mov	dpl,a
	mov	a,r7
...
00463$:
	...
	rlc	a
	mov	@r0,a
;	life.c:193: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:194: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
...
;	life.c:233: printstr("DONE ");
	...
	sjmp	00195$
00165$:
;	life.c:234: if (fixed) printstr("FIXED\r\n");
	mov	r0,#_fixed
	mov	a,@r0
	jz	00121$
	mov	r5,#___str_7
...
;	life.c:234: if (fixed) printstr("FIXED\r\n");
	...
	sjmp	00198$
00121$:
;	life.c:235: else printstr("CYCLE2\r\n");
	mov	r5,#___str_8
	mov	r6,#(___str_8 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
...
;	life.c:206: for (i0 = 0; !i0; ) {		
	...
	ljmp	00210$
00476$:
;	life.c:247: terminate:
00130$:
;	life.c:248: EA = 0;
;	assignBit
	clr	_EA
;	life.c:249: printstr("TERM\r\n");
	mov	r5,#___str_10
	mov	r6,#(___str_10 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
