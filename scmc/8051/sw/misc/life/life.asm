...
;	assignBit
	setb	_EA
;	life.c:205: for (i0 = 0; !i0; ) {		
	mov	dptr,#_i0
	clr	a
	movx	@dptr,a
00197$:
;	life.c:206: printstr("\033[2J\033[mINIT\r\n");
	mov	r5,#___str_4
	mov	r6,#(___str_4 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
...
;	life.c:208: c = getchar();
	...
	inc	dptr
	movx	@dptr,a
;	life.c:209: if (i0 || (c == (int)'T')) goto terminate;
	mov	dptr,#_i0
	movx	a,@dptr
	jz	00386$
	ljmp	00127$
...
;	life.c:220: c = getchar();
	...
	inc	dptr
	movx	@dptr,a
;	life.c:221: if (i0 || (c == (int)'T')) goto terminate;
	mov	dptr,#_i0
	movx	a,@dptr
	jz	00408$
	ljmp	00127$
00408$:
	...
	ljmp	00127$
00409$:
;	life.c:222: if (c == (int)'L') goto reload;
	cjne	r6,#0x4c,00410$
	cjne	r7,#0x00,00410$
	ljmp	00109$
00410$:
;	life.c:223: if (c == (int)'S') break;
	cjne	r6,#0x53,00118$
	cjne	r7,#0x00,00118$
...
00206$:
	...
	mov	dph,r6
	movx	@dptr,a
;	life.c:184: cycle2 |= pu[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	dptr,#_y
	mov	a,_bp
	add	a,#0x0e
	mov	r0,a
	...
	orl	a,r7
	movx	@dptr,a
;	life.c:185: fixed |= u[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,r4
	add	a,#_u
	mov	dpl,a
	mov	a,r5
...
00422$:
	...
	rlc	a
	movx	@dptr,a
;	life.c:192: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:193: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
...
;	life.c:205: for (i0 = 0; !i0; ) {		
	...
	ljmp	00197$
00430$:
;	life.c:244: terminate:
00127$:
;	life.c:245: EA = 0;
;	assignBit
	clr	_EA
;	life.c:246: printstr("TERM\r\n");
	mov	r5,#___str_8
	mov	r6,#(___str_8 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
