...
;	life.c:220: while (1) {
00127$:
;	life.c:221: printstr("LIFE I L R O P S U");
	mov	dptr,#___str_10
	mov	b,#0x80
	lcall	_printstr
;	life.c:222: putchar(pruni ? (int)'1' : (int)'0');
	mov	r0,#_pruni
	mov	a,@r0
	jz	00239$
	mov	r6,#0x31
...
00240$:
	...
	mov	dph,r7
	lcall	_putchar
;	life.c:223: printstr(" B T\r\n");
	mov	dptr,#___str_11
	mov	b,#0x80
	lcall	_printstr
;	life.c:224: c = toupper(getchar());
	lcall	_getchar
	lcall	_toupper
	mov	r6,dpl
	mov	r7,dph
;	life.c:225: if (i0 || (c == (int)'T')) goto term;
	mov	r0,#_i0
	mov	a,@r0
	jz	00458$
	ljmp	00154$
00458$:
	...
	ljmp	00154$
00459$:
;	life.c:226: else if ((c == (int)'I') || (c == (int)'L') || (c == (int)'R')) {
	cjne	r6,#0x49,00460$
	cjne	r7,#0x00,00460$
	sjmp	00117$
00460$:
...
;	life.c:227: if (c == (int)'L') loadiu();
	sjmp	00105$
00104$:
;	life.c:228: else if (c == (int)'R') loadriu();
	cjne	r6,#0x52,00105$
	cjne	r7,#0x00,00105$
...
;	life.c:51: c2set = 0;
	mov	r0,#_c2set
	mov	@r0,#0x00
;	life.c:231: memcpy(u, iu, sizeof (iu));
	push	acc
	mov	a,#0x24
	push	acc
	mov	a,#_iu
...
;	life.c:232: show(PRUNI, u);
	...
	ljmp	00127$
00118$:
;	life.c:233: } else if (c == (int)'O') show(PRUNI, iu);
	cjne	r6,#0x4f,00115$
	cjne	r7,#0x00,00115$
	mov	a,#_iu
	push	acc
	...
	ljmp	00127$
00115$:
;	life.c:234: else if (c == (int)'P') show(PRHDR | PRUNI, u);
	cjne	r6,#0x50,00112$
	cjne	r7,#0x00,00112$
	mov	a,#_u
	push	acc
	...
	ljmp	00127$
00112$:
;	life.c:235: else if (c == (int)'U') pruni = !pruni;
	cjne	r6,#0x55,00109$
	cjne	r7,#0x00,00109$
	mov	r0,#_pruni
	mov	a,@r0
...
00494$:
	...
	ljmp	00150$
00495$:
;	life.c:240: if (pruni) show(PRCLR | PRHDR | PRUNI, u);
	mov	r0,#_pruni
	mov	a,@r0
	jz	00130$
	mov	a,#_u
...
;	life.c:245: if (fixed) {
	...
	mov	a,@r0
	jz	00135$
;	life.c:246: printstr("FIXED AT ");
	mov	dptr,#___str_12
	mov	b,#0x80
	lcall	_printstr
;	life.c:247: show(PRHDR, u);
	mov	a,#_u
	push	acc
	mov	a,#(_u >> 8)
	push	acc
...
;	life.c:248: break;
	sjmp	00150$
00135$:
;	life.c:249: } else if (!c2set) {
	mov	r0,#_c2set
	mov	a,@r0
	jnz	00138$
;	life.c:250: genc2 = gen;
	mov	r0,#_gen
	mov	ar4,@r0
	inc	r0
	mov	ar5,@r0
...
;	life.c:256: if (c > 0) {
	...
	ljmp	00233$
00512$:
;	life.c:257: c = toupper(c);
	mov	dpl,r6
	mov	dph,r7
	lcall	_toupper
	mov	r6,dpl
	mov	r7,dph
;	life.c:258: if (c == (int)'U') pruni = !pruni;
	cjne	r6,#0x55,00146$
	cjne	r7,#0x00,00146$
	mov	r0,#_pruni
	mov	a,@r0
...
00515$:
	...
	ljmp	00233$
00146$:
;	life.c:259: else if (c == (int)'T') i0 = 1;
	cjne	r6,#0x54,00143$
	cjne	r7,#0x00,00143$
	mov	r0,#_i0
	mov	@r0,#0x01
	ljmp	00233$
00143$:
;	life.c:260: else if (c == (int)'B') i1 = 1;
	cjne	r6,#0x42,00518$
	cjne	r7,#0x00,00518$
	sjmp	00519$
00518$:
...
;	life.c:264: if (i1) {
	...
	mov	a,@r0
	jz	00236$
;	life.c:265: printstr("BREAK AT ");
	mov	dptr,#___str_13
	mov	b,#0x80
	lcall	_printstr
;	life.c:266: show(PRHDR, u);
	mov	a,#_u
	push	acc
	mov	a,#(_u >> 8)
	push	acc
