...
;	life.c:25: __idata static const char digits[16] = {
	...
	mov	@r0,#0x46
;	life.c:153: __idata static const char busy[4] = { '\\', '|', '/', '-' };
	mov	r0,#_busy
	mov	@r0,#0x5c
	mov	r0,#(_busy + 0x0001)
	mov	@r0,#0x7c
...
;	assignBit
	setb	_EA
;	life.c:207: for (i0 = 0; !i0; ) {		
	mov	r0,#_i0
	mov	@r0,#0x00
00210$:
;	life.c:208: printstr("\033[2J\033[mINIT\r\n");
	mov	r5,#___str_4
	mov	r6,#(___str_4 >> 8)
	mov	r7,#0x80
;	life.c:49: return;
...
;	life.c:222: c = toupper(getchar());
	...
	inc	r0
	mov	@r0,ar7
;	life.c:223: if (i0 || (c == (int)'T')) goto terminate;
	mov	r0,#_i0
	mov	a,@r0
	jz	00447$
	ljmp	00130$
00447$:
	...
	ljmp	00130$
00448$:
;	life.c:224: if (c == (int)'L') goto reload;
	cjne	r6,#0x4c,00449$
	cjne	r7,#0x00,00449$
	ljmp	00109$
00449$:
;	life.c:225: if (c == (int)'S') break;
	cjne	r6,#0x53,00118$
	cjne	r7,#0x00,00118$
...
;	life.c:160: for (y = 0; y < H; y++) {
	...
	mov	@r0,a
00192$:
;	life.c:161: putchar(busy[bstep]); putchar('\r');
	mov	r0,#_bstep
	mov	a,@r0
	add	a,#_busy
	mov	r1,a
...
;	life.c:183: n += u[A2D(W, (y + y1 + H) % H, (x + x1 + W) % W)];
	...
	mov	r0,#_n
	mov	@r0,ar7
;	life.c:185: nu[A2D(W, y, x)] = (n == 3) || ((n == 2) && u[A2D(W, y, x)]);
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,#_nu
...
00219$:
	...
	mov	dph,r6
	movx	@dptr,a
;	life.c:186: cycle2 |= pu[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	r0,#_y
	mov	ar6,@r0
	inc	r0
	mov	a,@r0
	...
	orl	a,@r0
	mov	@r0,a
;	life.c:187: fixed |= u[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,r6
	add	a,#_u
	mov	dpl,a
	mov	a,r7
...
00463$:
	...
	rlc	a
	mov	@r0,a
;	life.c:194: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:195: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x08
	push	acc
...
;	life.c:234: printstr("DONE ");
	...
	sjmp	00195$
00165$:
;	life.c:235: if (fixed) printstr("FIXED\r\n");
	mov	r0,#_fixed
	mov	a,@r0
	jz	00121$
	mov	r5,#___str_7
...
;	life.c:235: if (fixed) printstr("FIXED\r\n");
	...
	sjmp	00198$
00121$:
;	life.c:236: else printstr("CYCLE2\r\n");
	mov	r5,#___str_8
	mov	r6,#(___str_8 >> 8)
	mov	r7,#0x80
;	life.c:49: return;
...
;	life.c:207: for (i0 = 0; !i0; ) {		
	...
	ljmp	00210$
00476$:
;	life.c:248: terminate:
00130$:
;	life.c:249: EA = 0;
;	assignBit
	clr	_EA
;	life.c:250: printstr("TERM\r\n");
	mov	r5,#___str_10
	mov	r6,#(___str_10 >> 8)
	mov	r7,#0x80
;	life.c:49: return;
