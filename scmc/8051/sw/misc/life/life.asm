...
;------------------------------------------------------------
;	life.c:64: void int0(void) __interrupt 0 __using 1 {
;	-----------------------------------------
;	 function int0
;	-----------------------------------------
_int0:
...
;	life.c:99: if (hdr) {
	...
	ljmp	00102$
00241$:
;	life.c:100: printstr("\033[2J\033[m");
	mov	r5,#___str_0
	mov	r6,#(___str_0 >> 8)
	mov	r7,#0x80
;	life.c:48: return;
...
;	life.c:90: for (j = 0; j < 4; j++) {
	...
	movx	@dptr,a
00130$:
;	life.c:91: print16x(generation[3 - j]);
	mov	dptr,#_j
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00252$:
	...
	inc	dptr
	movx	@dptr,a
;	life.c:83: if (generation[j]) break;
	mov	dptr,#_j
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
;	life.c:107: for (y = 0; y < H; y++)
	...
	movx	@dptr,a
00143$:
;	life.c:108: if (u[A2D(W, y, x)]) printstr("[]");
	mov	dptr,#_y
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
;	life.c:198: printstr("RDY\r\n");
	...
	sjmp	00174$
00136$:
;	life.c:199: (void)getchar();
	lcall	_getchar
;	life.c:74: for (j = 0; j < 4; j++)
	mov	dptr,#_j
	clr	a
	movx	@dptr,a
	inc	dptr
...
00432$:
	...
	ljmp	00183$
00433$:
;	life.c:161: if (u[A2D(W, (y1 + H) % H, (x1 + W) % W)]) n++;
	mov	dptr,#_y1
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;	life.c:168: for (y = 0; y < H; y++)
	...
	ljmp	00190$
00445$:
;	life.c:174: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x04
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:175: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x04
	push	acc
