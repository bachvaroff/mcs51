...
;------------------------------------------------------------
;	life.c:135: static void loadiu(void) {
;	-----------------------------------------
;	 function loadiu
;	-----------------------------------------
_loadiu:
	...
	add	a,#0x04
	mov	sp,a
;	life.c:139: memset(iu, 0, sizeof (iu));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
	...
	dec	sp
	dec	sp
;	life.c:141: printstr("LOAD 0 1 ~ # <");
	mov	dptr,#___str_7
	mov	b,#0x80
	lcall	_printstr
;	life.c:143: for (nbits = 0, y = 0; y < (H * W); y += W) {
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	clr	a
...
;	life.c:154: break;
	sjmp	00116$
00107$:
;	life.c:155: } else if (c == (int)'~') goto br_inner;
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x7e,00181$
	inc	r0
	...
	sjmp	00130$
00181$:
;	life.c:156: else if (c == (int)'#') goto out;
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x23,00182$
	inc	r0
...
;	life.c:166: while (1) {
00123$:
;	life.c:167: c = getchar();
	lcall	_getchar
	mov	r6,dpl
	mov	r7,dph
;	life.c:168: if (c == (int)'#') break;
	cjne	r6,#0x23,00123$
	cjne	r7,#0x00,00123$
00126$:
;	life.c:170: print16x(nbits);
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	dpl,@r0
...
;------------------------------------------------------------
;	life.c:176: static void loadriu(void) {
;	-----------------------------------------
;	 function loadriu
;	-----------------------------------------
_loadriu:
;	life.c:179: printstr("RANDOM");
	mov	dptr,#___str_9
	mov	b,#0x80
	lcall	_printstr
...
;	life.c:200: for (y = 0; y < H; y++) {
	...
	mov	@r0,a
00135$:
;	life.c:201: OE76 = OE76_0 | ((y & 0x0003u) << 6);
	push	ar4
	push	ar5
	mov	a,_bp
	add	a,#0x11
...
;	life.c:217: UPDN(1, 1);
	...
	addc	a,r4
	mov	r6,a
;	life.c:220: nu[A2D(W, y, x)] = (n == 3) || ((n == 2) && u[A2D(W, y, x)]);
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	mov	a,@r0
...
00141$:
	...
	mov	dph,r2
	movx	@dptr,a
;	life.c:221: cycle2 |= pu[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,_bp
	add	a,#0x0f
	mov	r0,a
	mov	a,@r0
	...
	orl	a,@r0
	mov	@r0,a
;	life.c:222: fixed |= u[A2D(W, y, x)] ^ nu[A2D(W, y, x)];
	mov	a,r6
	add	a,#_u
	mov	dpl,a
	mov	a,r7
...
00186$:
	...
	rlc	a
	mov	@r0,a
;	life.c:232: memcpy(pu, u, sizeof (u));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
;	life.c:233: memcpy(u, nu, sizeof (nu));
	clr	a
	push	acc
	mov	a,#0x24
	push	acc
...
;	life.c:259: pruni = 0;
	mov	r0,#_pruni
	mov	@r0,#0x00
;	life.c:261: printstr("\033[?25h\033[m");
	mov	dptr,#___str_10
	mov	b,#0x80
	lcall	_printstr
;	life.c:263: for (i0 = 0; !i0; ) {
	mov	r0,#_i0
	mov	@r0,#0x00
;	life.c:264: while (1) {
00127$:
;	life.c:265: printstr("LIFE I L R O P S U");
	mov	dptr,#___str_11
	mov	b,#0x80
	lcall	_printstr
;	life.c:266: putchar(pruni ? (int)'1' : (int)'0');
	mov	r0,#_pruni
	mov	a,@r0
	jz	00170$
	mov	r6,#0x31
...
00171$:
	...
	mov	dph,r7
	lcall	_putchar
;	life.c:267: printstr(" B T\r\n");
	mov	dptr,#___str_12
	mov	b,#0x80
	lcall	_printstr
;	life.c:268: c = toupper(getchar());
	lcall	_getchar
	lcall	_toupper
	mov	r6,dpl
	mov	r7,dph
;	life.c:269: if (i0 || (c == (int)'T')) goto term;
	mov	r0,#_i0
	mov	a,@r0
	jz	00298$
	ljmp	00154$
00298$:
	...
	ljmp	00154$
00299$:
;	life.c:270: else if ((c == (int)'I') || (c == (int)'L') || (c == (int)'R')) {
	cjne	r6,#0x49,00300$
	cjne	r7,#0x00,00300$
	sjmp	00117$
00300$:
...
00301$:
	...
	cjne	r7,#0x00,00118$
00117$:
;	life.c:271: if (c == (int)'L') loadiu();
	cjne	r6,#0x4c,00104$
	cjne	r7,#0x00,00104$
	lcall	_loadiu
	sjmp	00105$
00104$:
;	life.c:272: else if (c == (int)'R') loadriu();
	cjne	r6,#0x52,00105$
	cjne	r7,#0x00,00105$
	lcall	_loadriu
00105$:
...
;	life.c:274: showu(PRUNI, u);
	...
	ljmp	00127$
00118$:
;	life.c:275: } else if (c == (int)'O') showu(PRUNI, iu);
	cjne	r6,#0x4f,00115$
	cjne	r7,#0x00,00115$
	mov	a,#_iu
	push	acc
	...
	ljmp	00127$
00115$:
;	life.c:276: else if (c == (int)'P') showu(PRHDR | PRUNI, u);
	cjne	r6,#0x50,00112$
	cjne	r7,#0x00,00112$
	mov	a,#_u
	push	acc
	...
	ljmp	00127$
00112$:
;	life.c:277: else if (c == (int)'U') pruni = !pruni;
	cjne	r6,#0x55,00109$
	cjne	r7,#0x00,00109$
	mov	r0,#_pruni
	mov	a,@r0
...
00314$:
	...
	ljmp	00127$
00109$:
;	life.c:278: else if (c == (int)'S') break;
	cjne	r6,#0x53,00315$
	cjne	r7,#0x00,00315$
	sjmp	00316$
00315$:
...
;	life.c:282: if (fxu()) {
	...
	mov	a,@r0
	jz	00130$
;	life.c:283: printstr("FIXED AT ");
	mov	dptr,#___str_13
	mov	b,#0x80
	lcall	_printstr
;	life.c:284: showu(PRHDR, u);
	mov	a,#_u
	push	acc
	mov	a,#(_u >> 8)
	push	acc
...
;	life.c:285: break;
	ljmp	00150$
00130$:
;	life.c:287: if (pruni) showu(PRCLR | PRHDR | PRUNI, u);
	mov	r0,#_pruni
	mov	a,@r0
	jz	00132$
	mov	a,#_u
...
;	life.c:60: fxset = 1;
	mov	r0,#_fxset
	mov	@r0,#0x01
;	life.c:293: printstr("FIXED AT ");
	mov	dptr,#___str_13
	mov	b,#0x80
	lcall	_printstr
;	life.c:294: showu(PRHDR, u);
	mov	a,#_u
	push	acc
	mov	a,#(_u >> 8)
	push	acc
...
;	life.c:295: break;
	ljmp	00150$
00135$:
;	life.c:297: if (cycle2) {
	mov	r0,#_cycle2
	mov	a,@r0
	jz	00139$
;	life.c:298: if (!c2u()) updatec2();
	mov	r0,#_c2set
	mov	a,@r0
	jnz	00139$
;	life.c:66: genc2 = gen;
...
;	life.c:302: if (c > 0) {
	...
	ljmp	00164$
00325$:
;	life.c:303: c = toupper(c);
	mov	dpl,r6
	mov	dph,r7
	lcall	_toupper
	mov	r6,dpl
	mov	r7,dph
;	life.c:304: if (c == (int)'U') pruni = !pruni;
	cjne	r6,#0x55,00146$
	cjne	r7,#0x00,00146$
	mov	r0,#_pruni
	mov	a,@r0
...
00328$:
	...
	ljmp	00164$
00146$:
;	life.c:305: else if (c == (int)'T') i0 = 1;
	cjne	r6,#0x54,00143$
	cjne	r7,#0x00,00143$
	mov	r0,#_i0
	mov	@r0,#0x01
	ljmp	00164$
00143$:
;	life.c:306: else if (c == (int)'B') i1 = 1;
	cjne	r6,#0x42,00331$
	cjne	r7,#0x00,00331$
	sjmp	00332$
00331$:
...
;	life.c:310: if (i1) {
	...
	mov	a,@r0
	jz	00167$
;	life.c:311: printstr("BREAK AT ");
	mov	dptr,#___str_14
	mov	b,#0x80
	lcall	_printstr
;	life.c:312: showu(PRHDR, u);
	mov	a,#_u
	push	acc
	mov	a,#(_u >> 8)
	push	acc
