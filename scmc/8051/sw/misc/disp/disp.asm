...
;	disp.c:188: gpo[GPO_OE] = OE;
	...
	mov	a,@r1
	movx	@r0,a
;	disp.c:190: if ((SKIPL > bit) || (bit > (7u - SKIPH))) continue;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	a,@r0
...
00234$:
	jc	00131$
;	disp.c:197: if ((r = getchar_poll()) >= 0) {
	lcall	_getchar_poll
	mov	r3,dpl
	mov	r4,dph
	mov	ar7,r3
	...
	mov	r6,a
	jb	acc.7,00120$
;	disp.c:198: r = toupper(r);
	mov	dpl,r7
	mov	dph,r6
	lcall	_toupper
	mov	r3,dpl
	mov	r4,dph
;	disp.c:199: if ((r == (int)'P') || (r == (int)' ')) {
	cjne	r3,#0x50,00237$
	cjne	r4,#0x00,00237$
	sjmp	00114$
00237$:
