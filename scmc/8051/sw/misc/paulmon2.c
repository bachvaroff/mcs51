...
void pm2_phex(unsigned char c) __naked {
	(void)c;
	__asm
	mov	a, dpl
	ljmp	pm2_entry_phex
...
void pm2_phex16(unsigned int i) __naked {
	(void)i;
	__asm
...
void pm2_pstr(char *str) __naked {
	(void)str;
	__asm
	ljmp	pm2_entry_pstr
	__endasm;
...
void pm2_pint8u(unsigned char c) __naked {
	(void)c;
	__asm
	mov	a, dpl
...
void pm2_pint16u(unsigned int i) __naked {
	(void)i;
	__asm
...
void pm2_newline(void) __naked {
	__asm
	ljmp	pm2_entry_newline
	__endasm;
}

void pm2_restart(void) __naked {
	__asm
	ljmp	0
	__endasm;
}
