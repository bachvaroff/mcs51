      ...
      00209F 74 3C            [12]  482 	mov	a,#___str_0
      0020A1 C0 E0            [24]  483 	push	acc
      0020A3 74 36            [12]  484 	mov	a,#(___str_0 >> 8)
      ...
      0020BD 74 4E            [12]  499 	mov	a,#___str_1
      0020BF C0 E0            [24]  500 	push	acc
      0020C1 74 36            [12]  501 	mov	a,#(___str_1 >> 8)
      ...
      002172 74 5A            [12]  629 	mov	a,#___str_2
      002174 C0 E0            [24]  630 	push	acc
      002176 74 36            [12]  631 	mov	a,#(___str_2 >> 8)
      ...
      00219D 74 69            [12]  655 	mov	a,#___str_3
      00219F C0 E0            [24]  656 	push	acc
      0021A1 74 36            [12]  657 	mov	a,#(___str_3 >> 8)
      ...
      0021BB 74 4E            [12]  672 	mov	a,#___str_1
      0021BD C0 E0            [24]  673 	push	acc
      0021BF 74 36            [12]  674 	mov	a,#(___str_1 >> 8)
      ...
      002270 74 5A            [12]  802 	mov	a,#___str_2
      002272 C0 E0            [24]  803 	push	acc
      002274 74 36            [12]  804 	mov	a,#(___str_2 >> 8)
      ...
      00228C 74 7A            [12]  820 	mov	a,#___str_4
      00228E C0 E0            [24]  821 	push	acc
      002290 74 36            [12]  822 	mov	a,#(___str_4 >> 8)
      ...
      0022E0 22               [24]  884 	ret
                                    ...
                                    887 	.area CONST   (CODE)
      00363C                        888 ___str_0:
      00363C 43 4F 4D 50 4C 45 54   889 	.ascii "COMPLETE base=%p "
             45 20 62 61 73 65 3D
             25 70 20
      00364D 00                     890 	.db 0x00
                                    891 	.area CSEG    (CODE)
                                    892 	.area CONST   (CODE)
      00364E                        893 ___str_1:
      00364E 6C 65 6E 3D 30 78 25   894 	.ascii "len=0x%04x "
             30 34 78 20
      003659 00                     895 	.db 0x00
                                    896 	.area CSEG    (CODE)
                                    897 	.area CONST   (CODE)
      00365A                        898 ___str_2:
      00365A 43 52 43 31 36 3D 30   899 	.ascii "CRC16=0x%04x"
             78 25 30 34 78
      003666 0D                     900 	.db 0x0d
      003667 0A                     901 	.db 0x0a
      003668 00                     902 	.db 0x00
                                    903 	.area CSEG    (CODE)
                                    904 	.area CONST   (CODE)
      003669                        905 ___str_3:
      003669 50 41 52 54 49 41 4C   906 	.ascii "PARTIAL base=%p "
             20 62 61 73 65 3D 25
             70 20
      003679 00                     907 	.db 0x00
                                    908 	.area CSEG    (CODE)
                                    909 	.area CONST   (CODE)
      00367A                        910 ___str_4:
      00367A 69 6E 74 65 72 72 75   911 	.ascii "interrupted"
             70 74 65 64
      003685 0A                     912 	.db 0x0a
      003686 00                     913 	.db 0x00
                                    914 	.area CSEG    (CODE)
                                    915 	.area XINIT   (CODE)
