...
;	walk.c:133: static volatile __xdata int *R = (__xdata int *)0xfffe;
	...
	inc	dptr
	movx	@dptr,a
;	walk.c:59: __idata static const struct node neigh[NMAX] = {
	mov	r0,#_neigh
	mov	@r0,#0xff
	inc	r0
	mov	@r0,#0xff
...
;------------------------------------------------------------
;	walk.c:73: static int update(struct node *t, struct node *cur, char j) {
;	-----------------------------------------
;	 function update
;	-----------------------------------------
_update:
...
;	walk.c:98: g[cur.r][cur.c] = 0xaa;
	...
	mov	a,#0xaa
	movx	@dptr,a
;	walk.c:99: printf("\033[%d;%dHo", cur.r + 4, cur.c + 1);
	mov	ar2,@r0
	inc	r0
	mov	ar5,@r0
	dec	r0
...
;	walk.c:101: next:
00102$:
;	walk.c:102: printf("\033[2;1H% 8d% 8d% 8d", sp, cur.r, cur.c);
	push	ar2
	mov	ar7,@r0
	inc	r0
	mov	ar4,@r0
...
;	walk.c:145: stinit();
	lcall	_stinit
;	walk.c:147: puts("\033[2J\033[?25l");
	mov	dptr,#___str_4
	mov	b,#0x80
	lcall	_puts
;	walk.c:149: while (i0) {
...
00172$:
	...
	subb	a,#0x80
	jc	00121$
;	walk.c:154: initial.r = rand() % ROWS;
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	push	ar7
	...
	mov	@r0,ar6
	dec	r0
;	walk.c:155: initial.c = rand() % COLS;
	mov	a,#0x02
	add	a,r1
	mov	r0,a
	push	ar1
	...
	mov	@r0,ar6
	dec	r0
;	walk.c:157: puts("\033[2J\033[?25l");
	mov	dptr,#___str_4
	mov	b,#0x80
	push	ar0
	lcall	_puts
	pop	ar0
	pop	ar1
;	walk.c:158: printf("\033[1;1H% 8u% 8d% 8d", N, initial.r, initial.c);
	mov	ar5,@r0
	inc	r0
	mov	ar6,@r0
	dec	r0
...
;	walk.c:164: if (g[i][j] != 0xaa) {
	...
	sjmp	00115$
00174$:
;	walk.c:165: (void)puts("Memory error");
	mov	dptr,#___str_0
	mov	b,#0x80
	push	ar7
	push	ar6
...
;	assignBit
	clr	_EA
;	walk.c:174: puts("\033[2J\033[?25h");
	mov	dptr,#___str_6
	mov	b,#0x80
	lcall	_puts
;	walk.c:178: __endasm;
...
;------------------------------------------------------------
;	walk.c:183: static void stinit(void) {
;	-----------------------------------------
;	 function stinit
;	-----------------------------------------
_stinit:
...
;------------------------------------------------------------
;	walk.c:188: static int stpush(struct node *t) {
;	-----------------------------------------
;	 function stpush
;	-----------------------------------------
_stpush:
	...
	mov	r6,dph
	mov	r7,b
;	walk.c:189: if (sp == (SMAX - 1)) return 0;
	mov	dptr,#_sp
	movx	a,@dptr
	mov	r3,a
	inc	dptr
...
;t                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	walk.c:195: static int stpop(struct node *t) {
;	-----------------------------------------
;	 function stpop
;	-----------------------------------------
_stpop:
