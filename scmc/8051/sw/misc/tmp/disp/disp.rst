      ...
      00200B 02 21 16         [24]  358 	ljmp	_timer0_intr
                                    ...
                                    372 ;	disp.c:34: __idata const uint8_t dcol[8] = {
      ...
      00209A 22               [24]  432 	ret
                                    ...
                                    437 ;------------------------------------------------------------
                                    438 ;	disp.c:51: void init_gpo(void) {
                                    439 ;	-----------------------------------------
      ...
      00209B                        442 _init_gpo:
                           ...
                           000001   449 	ar1 = 0x01
                           000000   450 	ar0 = 0x00
                                    451 ;	disp.c:52: P1_7 = 0;
                                    452 ;	assignBit
      00209B C2 97            [12]  453 	clr	_P1_7
                                    454 ;	disp.c:53: P2 = GPO_BASE_H;
      00209D 75 A0 F0         [24]  455 	mov	_P2,#0xf0
                                    456 ;	disp.c:54: CLEAR_GPO;
      ...
      002106 76 00            [12]  579 	mov	@r0,#0x00
                                    580 ;	disp.c:88: for (column = 0u; column < 8u; column++)
      ...
      002115 22               [24]  593 	ret
                                    ...
                                    598 ;------------------------------------------------------------
                                    599 ;	disp.c:96: void timer0_intr(void) __interrupt TF0_VECTOR __using 1 {
                                    600 ;	-----------------------------------------
      ...
      002164                        695 00102$:
                                    696 ;	disp.c:121: else ddata[j] = ddata[j - 1u] + 1u;
      ...
      0021A8                        766 00115$:
                                    767 ;	disp.c:149: else ddata[j] = ddata[j - 1u] + 1u;
