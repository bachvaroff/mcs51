...
;	disp.c:94: gpo[5] = 0u;
	mov	r0,#(_gpo + 0x0005)
	movx	@r0,a
;	disp.c:96: OE = 0x0fu; /* 00_001111 */
	mov	r0,#_OE
	mov	@r0,#0x0f
;	disp.c:97: gpo[GPO_OE] = OE; /* 00_001111 */
	mov	r0,#(_gpo + 0x0006)
	mov	a,#0x0f
	movx	@r0,a
;	disp.c:99: for (column = 0u; column < 8u; column++)
	mov	r0,#_column
	mov	@r0,#0x00
00103$:
	mov	r0,#_column
...
;------------------------------------------------------------
;	disp.c:107: void timer0_intr(void) __interrupt TF0_VECTOR __using 1 {
;	-----------------------------------------
...
;	disp.c:156: init_gpo();
	lcall	_init_gpo
;	disp.c:157: clear_gpo();
	lcall	_clear_gpo
;	disp.c:158: init_disp();
	lcall	_init_disp
