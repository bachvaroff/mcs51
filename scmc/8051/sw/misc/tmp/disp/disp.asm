...
;------------------------------------------------------------
;	disp.c:37: void init_timer0(void) {
;	-----------------------------------------
...
;------------------------------------------------------------
;	disp.c:49: void timer0_intr(void) __interrupt TF0_VECTOR __using 1 {
;	-----------------------------------------
...
_timer0_intr:
	...
	push	psw
	mov	psw,#0x08
;	disp.c:52: t = column & 7u;
	mov	r0,#_column
	mov	ar7,@r0
	mov	a,#0x07
	anl	a,r7
	mov	r6,a
;	disp.c:53: gpo[0] = ddata[t];
	mov	r0,#_gpo
	mov	ar1,@r0
	mov	a,r6
	add	a,#_ddata
...
;	disp.c:70: column = 0u;
	mov	r0,#_column
	mov	@r0,#0x00
;	disp.c:72: for (j = 0u; j < 8u; j++)
	mov	r7,#0x00
00108$:
;	disp.c:73: ddata[j] = 0u;	
	mov	a,r7
	add	a,#_ddata
	mov	r0,a
	mov	@r0,#0x00
...
00139$:
	jc	00108$
;	disp.c:74: init_timer0();
	lcall	_init_timer0
;	disp.c:76: init_intr();
	lcall	_init_intr
;	disp.c:79: for (j = 0u; j < 7; j++) {
00118$:
	mov	r7,#0x00
00110$:
;	disp.c:80: ddata[j]++;
