...
;	assignBit
	clr	_TR0
;	portme.c:22: TH0 = (65536 - 1382) / 256;
;	genAssign
	mov	_TH0,#0xfa
;	portme.c:23: TL0 = (65536 - 1382) % 256;
;	genAssign
	mov	_TL0,#0x9a
;	portme.c:24: TMOD = 0x01;
;	genAssign
	mov	_TMOD,#0x01
;	portme.c:25: IE = 0x82;
;	genAssign
	mov	_IE,#0x82
;	portme.c:26: TR0 = 1; // Start timers
;	genAssign
;	assignBit
	setb	_TR0
...
;------------------------------------------------------------
;	portme.c:29: void clockinc(void) __interrupt TF0_VECTOR __using 1
;	-----------------------------------------
;	 function clockinc
;	-----------------------------------------
_clockinc:
...
;	assignBit
	clr	_TR0
;	portme.c:34: TH0 = (65536 - 1382) / 256;
;	genAssign
	mov	_TH0,#0xfa
;	portme.c:35: TL0 = (65536 - 1382) % 256;
;	genAssign
	mov	_TL0,#0x9a
;	portme.c:36: TR0 = 1;
;	genAssign
